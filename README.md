...
Only tested in API v3, if you are use v1 or v2, please [Report an issue](https://github.com/swordkee/woocommerce-go/issues/new).

## Install

```go
go get github.com/swordkee/woocommerce-go
```
